                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="bg-white text-center xl:w-1/3 w-2/3 px-6 py-10 space-y-3 shadow-md">
                        ...
                        <div className="relative">
                            <input type={showPassword ? "text" : "password"} className="border w-full p-2 rounded-md font-arial text-darkb focus:outline-0" placeholder="Kata Sandi" autoComplete="off" value={password} onChange={(e) => setPassword(e.target.value)} />
