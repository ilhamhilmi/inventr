            ...
            <header className="hidden w-full z-50 fixed top-0 left-0 xl:flex items-center justify-center">
                <nav className="bg-transparent w-full px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="space-x-12">
                        <a href="" className="font-poppins tracking-wider border px-3 py-1.5 cursor-target text-white font-montserrat text-md">Features</a>
                        <a href="/login-operator" className="font-poppins tracking-wider border px-3 py-1.5 cursor-target text-white font-montserrat text-md">Login</a>
                    </div>
                </nav>
            </header>
            {/* Desktop End */}
